...
TRAMPOLINE_BASE = 0x0041cac4
TRAMPOLINE_ENTRY_BASE = 0x00116fa8


with open('96848841.no_autoreset.pnach', 'w') as pnach_file:
    # init the cheat
    pnach = pnach_utils.PnachWriter(pnach_file)
    cheat = pnach.begin_cheat('Lily\\NoAutoReset', 'modeco80', 'Disable auto reset functionalirt')
